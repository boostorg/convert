...
//    boost::conversion::optional<bool>t bool_res1 = boost::convert<bool>("1",     false, ccnv);
//    boost::conversion::optional<bool>t bool_res2 = boost::convert<bool>("true",  false, ccnv);
//    boost::conversion::optional<bool>t bool_res3 = boost::convert<bool>("yes",   false, ccnv);
//    boost::conversion::optional<bool>t bool_res4 = boost::convert<bool>(L"1",    false, wcnv);
//    boost::conversion::optional<bool>t bool_res5 = boost::convert<bool>(L"true", false, wcnv);
//    boost::conversion::optional<bool>t bool_res6 = boost::convert<bool>(L"yes",  false, wcnv);
//    boost::conversion::optional<bool>t bool_res7 = boost::convert<bool>("junk",   true, ccnv);
//
