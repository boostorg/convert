...
example4()
{
    ...
    int i2 = convert<int>(str, cnv).value_or_eval(fallback_func()); // Fallback functor is called if failed.
    int i3 = convert<int>(str, cnv, fallback_func()); // Fallback functor is called if failed.
    //]
}
static
void
